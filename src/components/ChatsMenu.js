...
const ChatsMenu = ({ onClose, onNewGroup, onNewCategory, onStarred, onPinned, onSettings }) => {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 bg-white rounded-lg shadow-xl py-2 min-w-[200px] z-30 border">
      {menuItems.map((item, index) => (
        <button 
          ...
          className="w-full px-4 py-3 text-left text-gray-700 hover:bg-gray-100 flex items-center space-x-3 transition-colors"
        >
